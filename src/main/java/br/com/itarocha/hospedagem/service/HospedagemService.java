...
import br.com.itarocha.hospedagem.dto.LeitoVO;
...
import br.com.itarocha.hospedagem.repository.HospedagemTipoServicoRepository;
import br.com.itarocha.hospedagem.repository.HospedeLeitoRepository;
import br.com.itarocha.hospedagem.repository.HospedeRepository;
...
public class HospedagemService {
	...
	@Inject HospedagemRepository hospedagemRepo;
	
	@Inject PessoaRepository pessoaRepo;
	
	@Inject TipoHospedeRepository tipoHospedeRepo;
	
	@Inject QuartoRepository quartoRepo;
	
	@Inject	LeitoRepository leitoRepo;
	
	@Inject HospedeLeitoRepository hospedeLeitoRepo;
	
	@Inject HospedeRepository hospedeRepo;
	
	@Inject TipoServicoRepository tipoServicoRepo;
	
	@Inject EntidadeRepository entidadeRepo;
	
	@Inject EncaminhadorRepository encaminhadorRepo;
	
	@Inject HospedagemTipoServicoRepository hospedagemTipoServicoRepo;
	...
	public boolean pessoaLivreNoPeriodo(Long pessoaId, LocalDate dataIni, LocalDate dataFim) {
	    return hospedeLeitoRepo.pessoaLivreNoPeriodo(pessoaId, dataIni, dataFim);
	}
	...
	public List<BigInteger> hospedagensNoPeriodo(Long leitoId, LocalDate dataIni, LocalDate dataFim) {
		return hospedeLeitoRepo.hospedagensNoPeriodo(leitoId, dataIni, dataFim);
	}
}
